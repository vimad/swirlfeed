...
class Post{
    ...
    public function submitPost($body,$user_to,$imageName=""){
        ...
        if($check_empty !='')
        {
            ...
            $num_posts++;
            $update_query = mysqli_query($this->con,"UPDATE users SET num_posts=$num_posts WHERE username='$userLoggedIn'");
    ...
    public function loadPostsFriends($pdata,$limit){
        $page = $pdata['page'];
        $userLoggedIn = $this->user_obj->getUsername();
        ...
        if(mysqli_num_rows($data)){
            ...
            while($row = mysqli_fetch_array($data))
            {
                ...
                if($user_logged_obj->isFriend($added_by))
                {
                    ...
                    $user_detail_query = mysqli_query($this->con,"SELECT * FROM users WHERE username='$added_by'");
                    ...
                    <script>
                        function toggle<?php echo $id;?>(){
                            ...
                            var elemant = document.getElementById("toggleComment<?php echo $id; ?>");

                            if(elemant.style.display == "block")
    ...
    public function loadProfilePosts($pdata,$limit){
        $page = $pdata['page'];
        $profileUser = $pdata['profileUsername'];
        $userLoggedIn = $this->user_obj->getUsername();
    ...
    public function getSinglePost($post_id){
        ...
        $str = "";
        $data = mysqli_query($this->con,"SELECT * FROM posts WHERE deleted='no' AND id='$post_id'");
        ...
        if(mysqli_num_rows($data)){
            ...
            $row = mysqli_fetch_array($data);
                ...
                }else
                {
                    $user_to_obj = new User($this->con,$row['user_to']);
                    $user_to_name = $user_to_obj->getFirstAndLastName();
                    $user_to = "to <a href='profile.php?profile_username=".$user_to_obj->getUsername()."'>".$user_to_name."</a>";
                }
